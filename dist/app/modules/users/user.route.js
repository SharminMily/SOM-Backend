...
router.get('/', user_controller_js_1.userController.getAllUsersFromDB);
router.get('/:id', user_controller_js_1.userController.getSingleUserFromDB);
router.delete('/', user_controller_js_1.userController.deleteUserFromDB);
